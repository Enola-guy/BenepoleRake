...
ActiveRecord::Schema.define(version: 20161201200948) do

  create_table "festivals", force: :cascade do |t|
    t.string   "name"
    t.string   "genre_musique"
    t.date     "date"
    t.string   "pays"
    t.boolean  "status"
    t.binary   "photo"
  ...
  add_index "personnes", ["confirmation_token"], name: "index_personnes_on_confirmation_token", unique: true
  ...
  add_index "personnes", [nil], name: "index_personnes_on_unlock_token", unique: true
