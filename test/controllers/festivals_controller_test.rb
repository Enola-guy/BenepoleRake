...
class FestivalsControllerTest < ActionController::TestCase
  ...
  test "should create festival" do
    assert_difference('Festival.count') do
      post :create, festival: { date: @festival.date, name: @festival.name, pays: @festival.pays, photo: @festival.photo, status: @festival.status, type: @festival.type }
    end
  ...
  test "should update festival" do
    patch :update, id: @festival, festival: { date: @festival.date, name: @festival.name, pays: @festival.pays, photo: @festival.photo, status: @festival.status, type: @festival.type }
    assert_redirected_to festival_path(assigns(:festival))
  end
